...
export const TASK_STATUS_CONFIG = {
  ...
  [TASK_STATUS.IN_PROGRESS]: {
    ...
    pillClass:   'bg-blue-500/10 text-blue-600 border border-blue-500/30 dark:bg-blue-500/15 dark:text-blue-400',
  ...
  [TASK_STATUS.NEEDS_REVIEW]: {
    ...
    pillClass:   'bg-amber-500/10 text-amber-700 border border-amber-500/30 dark:bg-amber-500/15 dark:text-amber-400',
  ...
  [TASK_STATUS.COMPLETE]: {
    ...
    pillClass:   'bg-green-500/10 text-green-700 border border-green-500/30 dark:bg-green-500/15 dark:text-green-400',
  ...
  [TASK_STATUS.VERIFIED]: {
    ...
    pillClass:   'bg-emerald-500/10 text-emerald-700 border border-emerald-500/30 dark:bg-emerald-500/15 dark:text-emerald-400',
  ...
  [TASK_STATUS.BLOCKED]: {
    ...
    pillClass:   'bg-red-500/10 text-red-700 border border-red-500/30 dark:bg-red-500/15 dark:text-red-400',
